...
const allure1 = require('allure-commandline')
...
exports.config = {
    ...
    baseUrl: 'https://hub.docker.com/search',
    //
    ...
    reporters: [['allure', {
     ...
     global.allure = allure;
            ...
            browser.url(`https://hub.docker.com/search`);
            browser.maximizeWindow()
        },
        beforeTest: function (test, context) {
            const chai = require('chai')
            const chaiwebdriveio = require('chai-webdriverio').default
            chai.use(chaiwebdriveio(browser))
            global.assert = chai.assert
            global.should = chai.should
            global.expect = chai.expect
            //allure.addSeverity('Critical')
            //allure.addIssue("Production Issue")
